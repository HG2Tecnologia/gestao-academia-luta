  ...
  Future<void> _salvar() async {
    ...
    try {
      ...
      await firestoreService.updateAcademia(academiaId, {
        ...
        'taxa_atraso_valor':
            double.tryParse(_taxaAtrasoValorCtrl.text.replaceAll(',', '.')) ??
            0.0,
      });
      if (!mounted) return;
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          Row(
                            children: [
                              ...
                              Switch(
                                ...
                                onChanged: (v) =>
                                    setState(() => _bloqueioCheckinAtivo = v),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Bloqueia após este número de dias do vencimento',
                                        style: TextStyle(
                                          color: kText2,
                                          fontSize: 12,
                                        ),
                                  ...
                                  children: [
                                    IconButton(
                                      icon: Icon(
                                        ...
                                        color: _carenciaDias > 0
                                            ? kPrimary
                                            : kBorder,
                                      ),
                                      onPressed: _carenciaDias > 0
                                          ? () =>
                                                setState(() => _carenciaDias--)
                                          : null,
                                    ...
                                    IconButton(
                                      icon: Icon(
                                        ...
                                        color: _carenciaDias < 30
                                            ? kPrimary
                                            : kBorder,
                                      ),
                                      onPressed: _carenciaDias < 30
                                          ? () =>
                                                setState(() => _carenciaDias++)
                                          : null,
                                      padding: EdgeInsets.zero,
                    ...
                    const SizedBox(height: 24),
                    _SectionLabel('Retenção de alunos'),
                    const SizedBox(height: 12),
                    Container(
                      padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Usada nos "Alunos em risco de evasão". Use {nome} '
                            'e {dias}. Em branco = mensagem padrão do sistema.',
                            style: TextStyle(color: kText2, fontSize: 12),
                          ),
                          const SizedBox(height: 10),
                          TextField(
                            controller: _msgEvasaoCtrl,
                            maxLines: 4,
                    ...
                    GestureDetector(
                      ...
                      child: _NavTile(
                        ...
                        subtitle:
                            'Ativar, desativar ou criar modalidades da academia',
                      ),
                    ),
                    const SizedBox(height: 12),
                    GestureDetector(
                    ...
                    GestureDetector(
                      ...
                      child: _NavTile(
                        ...
                        label: 'Notícias',
                        subtitle:
                            'Publicar notícias e comunicados para alunos e professores',
                      ),
                    ),
                    const SizedBox(height: 24),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Pontos XP concedidos ao aluno após responder',
                                        style: TextStyle(
                                          color: kText2,
                                          fontSize: 11,
                                        ),
                                ...
                                Row(
                                  children: [
                                    IconButton(
                                      icon: Icon(
                                        Icons.remove_circle_outline_rounded,
                                        color: _pesquisaXpRecompensa > 0
                                            ? kPrimary
                                            : kBorder,
                                      ),
                                      onPressed: _pesquisaXpRecompensa >= 25
                                          ? () => setState(
                                              () => _pesquisaXpRecompensa -= 25,
                                            )
                                          : null,
                                      padding: EdgeInsets.zero,
                                      constraints: const BoxConstraints(),
                                    ...
                                    IconButton(
                                      icon: Icon(
                                        Icons.add_circle_outline_rounded,
                                        color: _pesquisaXpRecompensa < 500
                                            ? kPrimary
                                            : kBorder,
                                      ),
                                      onPressed: _pesquisaXpRecompensa < 500
                                          ? () => setState(
                                              () => _pesquisaXpRecompensa += 25,
                                            )
                                          : null,
                    ...
                    GestureDetector(
                      ...
                      child: _NavTile(
                        ...
                        subtitle:
                            'Criar, ativar e ver resultados por tipo de pesquisa',
                      ),
                    ),
                    ...
                    GestureDetector(
                      ...
                      child: _NavTile(
                        ...
                        subtitle:
                            'Visualizar avaliações e comentários dos alunos',
                      ),
                    ),
                    const SizedBox(height: 24),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                _subdominio.isEmpty ? '—' : _subdominio,
                                style: TextStyle(
                                  color: kText1,
                                  fontWeight: FontWeight.w600,
                                ),
