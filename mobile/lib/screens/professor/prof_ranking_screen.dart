      ...
      body: _loading
          ...
          : _rankings.isEmpty
              ? ListaVazia(
                  ...
                  subtitulo: 'Solicite ao administrador que crie rankings.',
                )
              : RefreshIndicator(
                  onRefresh: _load,
                  color: kPrimary,
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Wrap(spacing: 6, children: [
            if (incPresencas)
              _chip('Presenças ×${ranking['pesoPresencas'] ?? 1}', kPrimary),
            if (incManuais)
              _chip('Pontos manuais ×${ranking['pesoManuais'] ?? 1}', kSuccess),
          ]),
          if (incManuais) ...[
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          TextFormField(
            ...
            validator: (v) {
              ...
              if (n == null || n < 1) return 'Informe um valor válido';
              return null;
            },
          ),
          const SizedBox(height: 14),
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: kBorder)),
              contentPadding: const EdgeInsets.symmetric(horizontal: 14, vertical: 12),
              hintText: 'Ex: Vitória no campeonato',
              hintStyle: TextStyle(color: kText2),
            ),
          ),
